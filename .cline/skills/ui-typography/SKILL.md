---
name: ui-typography
description: Detect font rendering and typography bugs in UI screen data including tofu glyphs, missing characters, font fallback issues, and text overlap. Use when analyzing UI screenshot data for font quality problems.
---
