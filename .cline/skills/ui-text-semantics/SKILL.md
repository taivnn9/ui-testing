---
name: ui-text-semantics
description: Detect text and semantic UI bugs in screen data including unrendered variables, wrong language, placeholder text, encoding errors, logic contradictions, and truncation issues. Use when analyzing UI screenshot data for text quality issues.
---
