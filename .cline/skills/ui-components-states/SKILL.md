---
name: ui-components-states
description: Detect UI component and app state bugs in screen data including small touch targets, missing labels, truncated buttons, skeleton/spinner states, empty states, error messages leaking, and platform safe area violations. Use when analyzing UI screenshot data for component and state issues.
---
