...
RULE_IMPL = {
    ...
    "LAY-01", "LAY-02", "LAY-03", "LAY-04", "LAY-14",
    "IMG-01", "IMG-02", "IMG-03", "IMG-05", "IMG-07", "IMG-08", "IMG-09", "IMG-12", "IMG-14",
...
DATA = [
    ...
    C("LAY-04", "Lệch grid (không theo 8pt)", "low", "trivial→medium", "",
      "bbox", "rule", "R1-LAY04 (`r1_geometry.check_grid_alignment`): bbox lệch lưới 8×dpr > GRID_TOLERANCE",
      "cạnh trái/trên lệch lưới 8pt > 2px (rõ ràng)", "bám lưới 8pt"),
    ...
    C("IMG-02", "Méo / sai tỉ lệ", "medium", "low→high", "",
      "`image_meta` (A7)", "rule", "R3-IMG02 (`r3_image.check_distortion`): |disp_ratio−intr_ratio|/intr_ratio",
    ...
    C("IMG-09", "Scale-mode sai", "medium", "low→high", "",
      "`image_meta.scale_mode`", "rule", "R3-IMG09 (`r3_image.check_scale_mode`): scale_mode='stretch'",
      "scale_mode='stretch' (không giữ tỉ lệ)", "fit/fill/none"),
